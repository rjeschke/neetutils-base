...
class XIterableZipWith<A, B, C> extends AbstractXIterable<C>
{
    ...
    private final FnCombine<A, B, C> combine;

    public XIterableZipWith(final Iterable<A> iterableA, final Iterable<B> iterableB, final FnCombine<A, B, C> combine)
    {
    ...
    private final static class XIterator<A, B, C> implements Iterator<C>
    {
        ...
        public XIterator(final Iterator<A> iteratorA, final Iterator<B> iteratorB, final FnCombine<A, B, C> combine)
        {
