...
{
    /** serialVersionUID */
    private static final long          serialVersionUID = 6883668697311952661L;
    /** Initial size. */
     ...
     * @return The list.
     */
    public static IntList fromArray(final int... values)
    {
    ...
    public boolean equals(final Object other)
    {
        ...
        final IntList list = (IntList)other;
    ...
    {
        final IntList list = new IntList(this.size);
        list.size = this.size;
    ...
    private void readObject(final ObjectInputStream in) throws IOException, ClassNotFoundException
    {
        ...
        this.data = new int[this.maxSize = this.size];
        for (int i = 0; i < this.size; i++)
        {
